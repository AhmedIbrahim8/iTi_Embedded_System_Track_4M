...
int main(){
	...
	do{
		...
		printf("To Add Node by position     Enter  (2)\n");
		printf("To delete node by its value Enter  (3)\n");
		printf("To Print the linked List    Enter  (4)\n");
		printf("To Exit press               Enter  (5)\n");
		printf("Your choice : ");
		scanf("%d",&choice);
		switch(choice){
			...
			break;
			case 2:
			printf("Inserting Node by position.............\n");
			printf("Please, Enter Node value : ");
			scanf("%d",&data);
...
void insertNodeInsideList(int data,int position){
	...
	*/
	if(head==NULL_PTR){
		...
		link->next=NULL_PTR;
		link->data=data;
		printf("Linked List is empty, Inserting at position 0 \n");
		return;
	}
