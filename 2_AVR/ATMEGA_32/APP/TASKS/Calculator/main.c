...
//		/*                  1 - calculator                                  */
//		/*                  2 - conversion                                  */
//		/*                      2.1 convert from decimal to binary          */
//		/*                      2.2 convert from decimal to hexa            */
...
//			keypad_state=KPD_u8GetPressedKey(KEYPAD1_INDEX);
//		}
//		/* If key state not one of the below character, the user entered a non valid choice */
//		/* Loop until user enter the correct choice                                         */
...
//		}
//		switch(keypad_state){
//		/* Calculator mode is chosen */
//		case '1':
//			LCD_voidClrScr(LCD1_INDEX_NUMBER);
//			/* call the calculator mode function */
//			Calculator();
//			while(keypad_state != KEYPAD_NOT_PRESSED){
//				keypad_state=KPD_u8GetPressedKey(KEYPAD1_INDEX);
//			}
...
//
//			break;
//			/* Conversion mode is chosen */
//		case '2':
//			LCD_voidClrScr(LCD1_INDEX_NUMBER);
//			/* call the convert mode function */
//			Convert();
//			while(keypad_state != KEYPAD_NOT_PRESSED){
//				keypad_state=KPD_u8GetPressedKey(KEYPAD1_INDEX);
//			}
