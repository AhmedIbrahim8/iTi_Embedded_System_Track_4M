...
void DIO_Init(void){
	...
	PORTB=CONCAT(DIO_PORTC_PIN7_VALUE,DIO_PORTC_PIN6_VALUE,DIO_PORTC_PIN5_VALUE,DIO_PORTC_PIN4_VALUE,DIO_PORTC_PIN3_VALUE,DIO_PORTC_PIN2_VALUE,DIO_PORTC_PIN1_VALUE,DIO_PORTC_PIN0_VALUE);
	...
	PORTB=CONCAT(DIO_PORTD_PIN7_VALUE,DIO_PORTD_PIN6_VALUE,DIO_PORTD_PIN5_VALUE,DIO_PORTD_PIN4_VALUE,DIO_PORTD_PIN3_VALUE,DIO_PORTD_PIN2_VALUE,DIO_PORTD_PIN1_VALUE,DIO_PORTD_PIN0_VALUE);
}
